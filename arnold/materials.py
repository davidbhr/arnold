def linear(stiffness):
    ...
    Args:
        ...
        D_0(float) : Buckling coefficient of the fibers for SAENO Simulation (see [Steinwachs,2015], default: linear material)
        L_S(float) : Onset of strain stiffening of the fibers (see [Steinwachs,2015], default: linear material)
        D_S(float) : Strain stiffening coefficient of the fibers (see [Steinwachs,2015], default: linear material)   
    """
